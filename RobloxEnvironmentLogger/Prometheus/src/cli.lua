...
-- ==================== ADD CUSTOM HEADER ====================
local header = [[
--- obfuscated using lularp 'larp' obfuscator by x9d link : https://discord.gg/Euz9EkZCEk
--- if you want to deobfuscate this, good luck, you'll need it.
--- also, if you want to use lularp, join the discord and obfuscate it easily its free and good : https://discord.gg/Euz9EkZCEk
]]
out = header .. out;
-- ===========================================================
